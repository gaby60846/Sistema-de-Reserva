...
<html lang="en">
    <head>
        ...
        <title>Reporte General - Componentes</title>
    </head>
    <body>
        <div class="page" id="pagePDF">
            ...
            <br>
            <div class="titulo">
                <h3>Informe general sobre los hoteles en el periodo <?php echo $fecha_ini; ?> a <?php echo $fecha_final; ?></h3>
            </div>
            <div class="overview">
                <h5>Descripción General</h5>
                <ul>
                    <li>Total generado: 1504,70$</li>
                    <li>Cantidad de componentes solicitados: 2548</li>
                    <li>Componente más solicitado: <i class="bi bi-wifi"></i> Wifi gratis</li>
                    <li>Componente menos solicitado: <i class="bi bi-person-wheelchair"></i> Adaptado personas de movilidad reducida</p></li>
                </ul>
            </div> 
